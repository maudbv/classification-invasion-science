...
col_clusters = c(
  "Propagule cluster" = "#00C177",
  "Darwin's cluster" = "#EF4266",
  "Darwin's cluster + Resource availability cluster" = "#ff8073",
  "Trait cluster + Darwin's cluster"  = "#3EB7BA",
  "Trait cluster + Darwin's cluster + Resource availability cluster + Propagule cluster"= "#a741ea",
  "Biotic interactions cluster" = "#93A0AB",
  "Resource availability cluster" = "#FAD05A",
 "Darwin's cluster + Biotic interactions cluster" = "#e8a4b2",
 "Resource availability cluster + Biotic interactions cluster" = "#D2C38B"
)
  
  
  
nodes_martin$color = col_clusters[match(nodes_martin$group, names(col_clusters))]
